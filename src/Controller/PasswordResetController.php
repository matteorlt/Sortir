...
final class PasswordResetController extends AbstractController
{
    ...
    public function request(
        ...
        // Ne pas révéler si l'emails est enregistré
        if ($user instanceof Participant) {
            ...
            try {
                ...
                $this->addFlash('warning', "L'emails n'a pas pu être envoyé en local: " . $e->getMessage());
            }
        }

        $this->addFlash('success', 'Si un compte correspond à cet emails, vous recevrez un lien de réinitialisation.');
